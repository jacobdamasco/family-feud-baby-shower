  ...
  return (
    ...
    <div className="container-round">
        <div className="container-answer mx-auto my-auto">
          ...
          <AnswerCard answerNum={"1"} answer={"WORD"} answerPts={41} currRoundScore={roundScore} setRoundScore={setRoundScore}/>
          <AnswerCard answerNum={"5"} answer={"HAIRCUT"} answerPts={3} currRoundScore={roundScore} setRoundScore={setRoundScore}/>
          <AnswerCard answerNum={"2"} answer={"STEPS"} answerPts={31} currRoundScore={roundScore} setRoundScore={setRoundScore}/>
          <BlankCard />
          <AnswerCard answerNum={"3"} answer={"TOOTH"} answerPts={16} currRoundScore={roundScore} setRoundScore={setRoundScore}/>
          <BlankCard />
          <AnswerCard answerNum={"4"} answer={"SMILE"} answerPts={8} currRoundScore={roundScore} setRoundScore={setRoundScore}/>
          <BlankCard />
        </div>
